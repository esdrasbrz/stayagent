        ...
        try:
            async with async_playwright() as p:
                ...
                try:
                    ...
                    logger.warning("Could not find Airbnb listing elements, page layout might have changed or got blocked.")
                    listings = []
                ...
                for i, listing in enumerate(listings):
                    ...
                    try:
                        ...
                        name = ""
                        title_loc = listing.locator('div[data-testid="listing-card-title"]')
