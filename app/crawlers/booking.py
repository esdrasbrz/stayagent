        ...
        try:
            async with async_playwright() as p:
                ...
                try:
                    ...
                    listings = await page.locator('div[data-testid="property-card"]').all()
                except Exception:
                    logger.warning("Could not find Booking listing cards, page layout might have changed or got blocked.")
                    listings = []
