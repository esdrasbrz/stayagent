...
@pytest.mark.asyncio
async def test_airbnb_crawler_live_standard(future_dates):
...
@pytest.mark.asyncio
async def test_airbnb_crawler_live_large_group(future_dates):
...
@pytest.mark.asyncio
async def test_airbnb_crawler_live_long_stay(future_dates_long):
